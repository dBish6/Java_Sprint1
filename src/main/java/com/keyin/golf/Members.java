...
public class Members {
    ...
    public Members(String firstName, String lastName, String address, String email, int phoneNumber, Date membershipStartDate, Date membershipEndDate, ArrayList currentTournaments, ArrayList upcomingTournaments, ArrayList pastTournaments){
...
//        List<Members> first = members.getMembersByFirstName(firstName);
//        List<Members> golf = members.getAllMembers();
//
//        List<Members> membersToReturn = new ArrayList<Members>();
//
//        for (Members a : golf) {
//            if (a.getMembers().getName().equals(members.getName())) {
//                membersToReturn.add(a);
//            }
//        }
//
...
//    }
//
//    private List<Members> getAllMembers() {
//        return null;
//    }
//
